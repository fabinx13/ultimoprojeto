...
<body>
    <a href="list_products.php" class="back">
        < Voltar</a>
            <!-- Navbar -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            ?>
                                            <div class="font-weight-bold mt-2">Total: R$
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#Modal<?php echo $row['id']; ?>">Excluir</button>
                                    </td>
                                </tr>

                                <!-- Modal de confirmação para excluir pedido -->
                                <div class="modal fade" style="z-index:99999; color: black !important;"
                                    id="Modal<?php echo $row['id']; ?>" tabindex="-1" role="dialog"
                                    aria-labelledby="ModalLabel<?php echo $row['id']; ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="ModalLabel<?php echo $row['id']; ?>">Confirmar
                                                    Exclusão</h5>
            ...
            <?php if ($status === 'success'): ?>
                <div class="modal fade " style="z-index:99999; color: black !important" id="successModal" tabindex="-1" role="dialog"
